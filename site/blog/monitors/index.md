...
ttf_hinting.png
Verdana (k) and Times New Roman Italic (z) before rasterization at 13px. [Source](http://web.archive.org/web/20160304021305/http://antigrain.com/research/font_rasterization/index.html)
...
hinting_failures.png

hinting_failures_2.png
...
windows_cleartype.png

but even if you turn it off, you’ll have to go through configuring ClearType anyway. There’s just no OK button <nobr>¯\_(ツ)_/¯</nobr>.
...
I guess you just have to know it <nobr>¯\_(ツ)_/¯</nobr>. Alternatively, one can look at the Apple’s [intuitively named page SP794](https://support.apple.com/kb/SP794?locale=en_US):
...
UPD 2021-02-24: I started building up [a list of Macs/Monitors compatibility](/blog/monitors-mac/). Check it out and help me update it!
