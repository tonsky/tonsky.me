...
.foot Switching branches while having dirty working copy (hover to animate)

<div class="anim" style="background-image: url(two-wips@2x.png);"></div>
.foot Keeping 2 dirty working copies (hover to animate)
...
<div class="anim" style="background-image: url(commit@2x.png);"></div>
.foot Commit by rename (hover to animate)

<div class="anim" style="background-image: url(staging@2x.png);"></div>
.foot Stage by split (hover to animate)
...
.foot Squash operation (hover to animate)
...
<div class="anim" style="background-image: url(rebase@2x.png);"></div>
.foot Using direct manipulation to imitate Git rebase

<div class="anim" style="background-image: url(cherry-pick@2x.png);"></div>
.foot Using direct manipulation to imitate cherry-pick (hover to animate)
...
.foot Moving HEAD pointer to imitate Git checkout (hover to animate)
...
overview@2x.png
Visualisation of DAG tree (static screenshot)
